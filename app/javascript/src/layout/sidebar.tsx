...
function Sidebar({
  ...
  return (
    <div className={`${drawerClass} md:flex md:flex-shrink-0`}>
      ...
      {current_page && (
        <div className="md:flex flex-col w-56 border-r border-gray-200 dark:border-gray-800 dark:bg-gray-900 bg-[#f5f5f4]">
          <div className="h-[63px] py-2 flex items-center flex-shrink-0 px-4 border-b border-gray-200 dark:border-gray-800 dark:text-gray-200">
